...
(cl:defmethod cl:initialize-instance :after ((m <complex>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'complex)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name customMSG-msg:<complex> is deprecated: use customMSG-msg:complex instead.")))

(cl:ensure-generic-function 'real-val :lambda-list '(m))
(cl:defmethod real-val ((m <complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader customMSG-msg:real-val is deprecated.  Use customMSG-msg:real instead.")
  (real m))

(cl:ensure-generic-function 'imaginray-val :lambda-list '(m))
(cl:defmethod imaginray-val ((m <complex>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader customMSG-msg:imaginray-val is deprecated.  Use customMSG-msg:imaginray instead.")
  (imaginray m))
