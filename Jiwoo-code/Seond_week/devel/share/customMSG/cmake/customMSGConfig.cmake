...
if("TRUE" STREQUAL "TRUE")
  set(customMSG_SOURCE_PREFIX /home/jiwoo/Desktop/jiwoo_study/seond_week/src/customMSG)
  set(customMSG_DEVEL_PREFIX /home/jiwoo/Desktop/jiwoo_study/seond_week/devel)
  ...
  set(customMSG_INSTALL_PREFIX /home/jiwoo/Desktop/jiwoo_study/seond_week/install)
...
if(NOT "/home/jiwoo/Desktop/jiwoo_study/seond_week/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'customMSG' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jiwoo/Desktop/jiwoo_study/seond_week/src/customMSG/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(customMSG_EXPORTED_TARGETS ${${customMSG_dep}_EXPORTED_TARGETS})
endforeach()
